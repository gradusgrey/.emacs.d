...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(## auctex calfw calfw-org cdlatex comment-dwim-2 doom-modeline doom-themes
				drag-stuff emacsql flycheck gnu-elpa-keyring-update highlight-symbol hl-todo
				magit marginalia markdown-mode mixed-pitch multiple-cursors neotree nyan-mode
				org org-alert org-bullets org-capture-pop-frame org-fragtog org-fragtop
				org-journal org-mode org-pomodoro org-roam org-super-agenda pandoc-mode
				pdf-tools tide use-package yasnippet zotxt))
 '(tetris-x-colors
